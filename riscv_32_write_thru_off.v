...
//
//      Instance Name:              riscv_32_write_thru_off
//      Words:                      2048
//      Bits:                       32
//      Mux:                        16
//      Drive:                      6
...
//      Test Muxes                  Off
//
//      Creation Date:  Thu Apr 14 23:27:45 2022
//      Version: 	r0p0-00eac0
//
...
`celldefine
`ifdef POWER_PINS
module riscv_32_write_thru_off (Q, CLK, CEN, WEN, A, D, EMA, RETN, VSSE, VDDPE, VDDCE);
`else
module riscv_32_write_thru_off (Q, CLK, CEN, WEN, A, D, EMA, RETN);
`endif
